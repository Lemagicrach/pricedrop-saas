...
// Validate ../../../app/api/cron/check-prices/route.ts
{
  type __IsExpected<Specific extends RouteHandlerConfig<"/api/cron/check-prices">> = Specific
  const handler = {} as typeof import("../../../app/api/cron/check-prices/route.js")
  type __Check = __IsExpected<typeof handler>
  // @ts-ignore
  type __Unused = __Check
}

// Validate ../../../app/api/products/track/route.ts
{
  type __IsExpected<Specific extends RouteHandlerConfig<"/api/products/track">> = Specific
  const handler = {} as typeof import("../../../app/api/products/track/route.js")
  type __Check = __IsExpected<typeof handler>
  // @ts-ignore
  type __Unused = __Check
}
